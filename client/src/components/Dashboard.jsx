...
import {DashBoardHome,DashboardUsers,DashboardReciters,DashboardRecites,DashboardAlbums,DashboardNewRecite} from '../components/index'
import {Route,Routes} from 'react-router-dom';


const Dashboard = () => {
  return (
    <div className='flex flex-col w-full h-auto items-center justify-center shadow-lg'>
    <Header/>

   
    <div className='w-[60%] my-2 p-2 flex items-center justify-evenly'>
