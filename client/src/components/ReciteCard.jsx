...
export const ReciteCard = ({ data,index }) => {
  ...
  return (
    <motion.div
     ...
     transition={{ duration: 0.4, delay: index * 0.1 }}
      className="relative w-full font-Euclid rounded-md flex items-center gap-2 justify-between py-3 bg-lightOverlay cursor-pointer hover:bg-card hover:shadow-md"
    >
      <p className="w-225 flex items-center justify-center">
        ...
        />
        <p className="w-200 text-lg flex  flex-col font-semibold font-Euclid text-center gap-6 text-gray-500">
            {data.name}
      ...
      <p className="w-100 text-md font-Euclid flex gap-1 justify-center items-center font-bold text-lighttextGray">{data.Album}
      <p className="w-160 text-lg font-Euclid text-gray-500">| {data.Reciter}</p>
      </p>
